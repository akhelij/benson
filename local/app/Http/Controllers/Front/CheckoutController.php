...
class CheckoutController extends Controller
{
    ...
    public function store(CartCheckoutRequest $request)
    {
        ...
        if(!$passiveOrder){
            // Get customer data and billing information
        ...
        switch ($method->slug) {
           ...
           /* case 'paypal':
                ...
                //Trouver une adresse de livraison enregistrer                
                $billingAddress = $this->addressRepo->findAddressById($request->input('billing_address'));
                if ($billingAddress->country_id == "Maroc" || $billingAddress->country_id == "Morocco") {
                    $courier->cost = 0;
                }
            ...
            case 'fpay':
                ...
                $MERCHANT_URL = "https://www.benson-shoes.com/payment/success";

                $FPAY_URLREPAUTO = "https://www.benson-shoes.com/fpayApi/response.php";
                ...
                $DATA = compact("AMOUNT", "CURRENCY_CODE", "TRANSACTION_CAPTURE", "MERCHANT_ID", "MERCHANT_KEY", "MERCHANT_URL", "FPAY_URLREPAUTO", "ORDER_ID", "ORDER_DETAILS","CUSTOMER_ID", "CUSTOMER_LASTNAME", "CUSTOMER_FIRSTNAME", "CUSTOMER_EMAIL", "CUSTOMER_PHONE", "CUSTOMER_ADDRESS", "CUSTOMER_CITY", "CUSTOMER_STATE", "CUSTOMER_ZIPCODE", "CUSTOMER_COUNTRY", "CUSTOM_DATA", "LANGUAGE", "FPAY_URL", "CONVERSION_CURRENCY", "AMOUNT_CONVERSION", "CONVERTED_AMOUNT", "CUSTOMER_MESSAGE");
                $URL = env("APP_URL");
                $BASE = storage_path() . "/logs";
                
                return view('cmi.PaymentRequest',compact('DATA'));
            ...
            case 'paiement-a-la-livraison':
                ...
                break;
            default:
                return view('cart.index')->with('message',"Veuillez choisir une methode de paiement valide");
        }
    }
    ...
    {
        return view('cmi.PaymentRequest');
   ...
   /* public function successfpay()
    {
       // return view()  1.PaymentRequest.php
    }*/
}
