                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="slug">Slug <span class="text-danger">* To have a uniq slug add "-color of the shoe" to the end without spaces exampl : patrick-vegano or harry-cognac <br> Prefinie => pre // Epi => epi // W =>  w // BL => bl</span></label>
