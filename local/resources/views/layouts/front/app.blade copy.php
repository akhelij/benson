            ...
            <div style="display: block;
                ...
                <div class="pull-left">
                    <ul class="mini-header nav navbar-nav navbar-left ">
                        <li>
                            Pour tout retour ou échange prière de contacter : 
                        </li>
                        <li>
                            +212 6 60 08 05 
                        </li>
                                        ...
                                        <ul class="list-unstyled list-inline nav navbar-nav col-md-12"  >
                                                ...
                                                @foreach($categories as $category)
                                                    ...
                                                    @if($category->name == "Accessoires")
                                                            <li class="col-md-2">
                                                                    <div class="dropdown">
                                                                            <a  href="{{route('front.category.slug', $category->slug)}}" class="dropdown-toggle" id="{{$category->slug}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Accessoires et Entretien <span class="caret"></span></a>
                                                                            <ul class="dropdown-menu" aria-labelledby="{{$category->slug}}">
                                                                                    <li><a class="sub" href="{{route('front.category.slug', $category->slug)}}">Nos Accessoires</a></li>
                                                                                    <!--<li ><a class="sub" href="#" disabled style="color:grey !important">Produits saphir</a></li>-->
                                                                                    <li><a class="sub" href="{{route('maintain')}}">Conseils d'entretien</a></li>
                                                                            </ul>
                                                                        </div>
