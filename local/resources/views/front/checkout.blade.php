                ...
                <div class="row" style="margin:0;background-color: #fff;padding-bottom:20px"> 
                    ...
                    <div class="col-md-12 content">
                        ...
                        @if(count($addresses) > 0)
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3> <i class="fa fa-money text-success"></i> Methode de paiement</h3>
                                    @if($payments)
                                        <table class="table ">
                                            <thead>
                        ...
                        @else
                            <p class="alert alert-danger"><a href="{{ route('customer.address.create', [$customer->id * 15212]) }}">Aucune adresse n'a été ajoutée<br/>
                                    Pour continuer veuillez entrer une adresse</a>
                                    <br><br>
                             <!-- Main content -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <a href="{{ route('cart.index') }}" class="btn btn-default"> <i class="fa fa-shopping-basket"></i> Reverifier le panier</a>
