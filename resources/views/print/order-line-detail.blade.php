                            ...
                            <tbody>
                                ...
                                <tr style="background-color: #fff !important">
                                    ...
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 5 : 4 }}
                                        </span>
                                        <hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 35 : 38 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 5.5 : 4.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 6 : 5 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 36 : 39 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 6.5 : 5.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 7 : 6 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 37 : 40 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 7.5 : 6.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 8 : 7 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 38 : 41 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 8.5 : 7.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 9 : 8 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 39 : 42 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 9.5 : 8.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 10 : 9 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 40 : 43 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 10.5 : 9.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 11 : 10 }}
                                        </span><hr>
                                        <span class="pointure français" >
                                            {{ $orderLine->genre == 'femme' ? 41 : 44 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 11.5 : 10.5 }}
                                        </span><hr>
                                        <span class="français" >x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 12 : 11 }}
                                        </span><hr>
                                        <span class="pointure français">
                                            {{ $orderLine->genre == 'femme' ? 42 : 45 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 12.5 : 11.5 }}
                                        </span><hr>
                                        <span class="français">x</span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 13 : 12 }}
                                        </span><hr>
                                        <span class="pointure français">
                                            {{ $orderLine->genre == 'femme' ? 43 : 46 }}
                                        </span>
                                    </th>
                                    <th class="size-header">
                                        <span class="anglais">
                                            {{ $orderLine->genre == 'femme' ? 14 : 13 }}
                                        </span><hr>
                                        <span class="pointure français">
                                            {{ $orderLine->genre == 'femme' ? 44 : 47 }}
                                        </span>
                                    </th>
                                    <th>Total</th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @else
                                        ...
                                        <td>{{ $orderLine->p15x == 0 ? '' : $orderLine->p15x }}</td> {{-- 46.5 --}}
                                        <td>{{ $orderLine->p16 == 0 ? '' : $orderLine->p16 }}</td> {{-- 47 --}}
                                        <td>{{ $orderLine->p17 == 0 ? '' : $orderLine->p17 }}</td> {{-- 48 --}}
                                    @endif
                        ...
                        <table class="table table-striped table-bordered table-dataTable" style="height: 25%;">
                            <tbody>
                                <tr style="background-color: #fff !important">
                                    ...
                                    <td colspan="5">{{ $orderLine->formeItem->nom ?? '-' }}/{{ $orderLine->articleItem->nom ?? '-' }}</td>
                                    <td colspan="5">{{ $orderLine->semelleItem->nom ?? '-' }}/{{ $orderLine->constructionItem->nom ?? '-' }}</td>
                                    <td colspan="5">{{ $orderLine->cuirItem->nom ?? '-' }}/{{ $orderLine->doublureItem->nom ?? '-' }}</td>
                                    <td colspan="5">{{ $orderLine->supplementItem->nom ?? '-' }}</td>
                                </tr>
                        ...
                        <table class="table table-striped table-bordered table-dataTable" style="height: 25%;">
                            <tbody>
                                <tr style="background-color: #fff !important">
                                    ...
                                    <td colspan="4">{{ $orderLine->formeItem->nom ?? '-' }}/{{ $orderLine->articleItem->nom ?? '-' }}</td>
                                    <td colspan="5">{{ $orderLine->semelleItem->nom ?? '-' }}/{{ $orderLine->constructionItem->nom ?? '-' }}</td>
                                    <td colspan="4">{{ $orderLine->cuirItem->nom ?? '-' }}/{{ $orderLine->doublureItem->nom ?? '-' }}</td>
                                    <td colspan="5">{{ $orderLine->supplementItem->nom ?? '-' }}</td>
                                </tr>
