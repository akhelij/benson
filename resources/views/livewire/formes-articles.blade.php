                            ...
                            @else
                                <td class="px-4 py-3">
                                    @if($forme->getFirstMediaUrl('images'))
                                        <img src="{{ $forme->getFirstMediaUrl('images') }}" alt="{{ $forme->nom }}" class="w-10 h-10 object-cover rounded-lg shadow-sm">
                                    @else
                            ...
                            @else
                                <td class="px-4 py-3">
                                    @if($article->getFirstMediaUrl('images'))
                                        <img src="{{ $article->getFirstMediaUrl('images') }}" alt="{{ $article->nom }}" class="w-10 h-10 object-cover rounded-lg shadow-sm">
                                    @else
