...
<div>
    ...
    <div class="space-y-4">
        ...
        <div>
            <label for="actualDeliveryDate" class="block text-sm font-medium text-gray-700">
                Date de Livraison Réelle (optionnel)
            </label>
            <input {{ $attributes->wire('model.date') }} id="actualDeliveryDate" type="date"
                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
        </div>
        ...
        <div>
            ...
            <textarea {{ $attributes->wire('model.notes') }} id="deliveryNotes" rows="3"
